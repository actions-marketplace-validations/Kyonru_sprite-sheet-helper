...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
 ...
 className={cn(
 "hover:after:bg-sidebar-border absolute inset-y-0 z-20 w-4 -translate-x-1/2 rtl:translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] flex",
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
 ...
 "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2",
 className,
 )}
 {...props}
 />
